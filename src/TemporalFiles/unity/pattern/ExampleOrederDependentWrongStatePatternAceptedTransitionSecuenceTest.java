...
public class ExampleOrederDependentWrongStatePatternAceptedTransitionSecuenceTest {
	...
	private List<String> getFinalStatesCanonicalNames () {
		...
		result.add("tfg.sw.implementationExample.pattern.state.ExampleOrderDependentWrong.State1");
		result.add("tfg.sw.implementationExample.pattern.state.ExampleOrderDependentWrong.State3");
