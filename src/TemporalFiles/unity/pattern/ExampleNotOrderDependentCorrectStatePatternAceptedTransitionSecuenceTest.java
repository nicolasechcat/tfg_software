...
import tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.State;

import tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.Context;

import tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.State1;


public class ExampleNotOrderDependentCorrectStatePatternAceptedTransitionSecuenceTest {
	...
	private State executeActionSecuence (List<Integer> transitonOrder) throws Exception {
		...
		if (initialStateClassName.compareTo("tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.State1") != 0) 
			return null;
	...
	private List<String> getFinalStatesCanonicalNames () {
		...
		result.add("tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.State1");
		result.add("tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentCorrect.State3");
