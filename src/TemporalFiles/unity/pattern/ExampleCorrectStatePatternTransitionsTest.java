...
import tfg.sw.implementationExample.pattern.state.ExampleCorrect.State2;
import tfg.sw.implementationExample.pattern.state.ExampleCorrect.State3;


public class ExampleCorrectStatePatternTransitionsTest {
