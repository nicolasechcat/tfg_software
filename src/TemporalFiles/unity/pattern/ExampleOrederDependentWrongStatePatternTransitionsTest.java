...
import tfg.sw.implementationExample.pattern.state.ExampleOrderDependentWrong.State2;
import tfg.sw.implementationExample.pattern.state.ExampleOrderDependentWrong.State3;


public class ExampleOrederDependentWrongStatePatternTransitionsTest {
