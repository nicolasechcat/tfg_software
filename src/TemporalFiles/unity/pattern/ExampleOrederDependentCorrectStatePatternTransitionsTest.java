...
import tfg.sw.implementationExample.pattern.state.ExampleOrderDependentCorrect.State2;
import tfg.sw.implementationExample.pattern.state.ExampleOrderDependentCorrect.State3;


public class ExampleOrederDependentCorrectStatePatternTransitionsTest {
	...
	public void test7TransitionState3action2State1
		...
		context.setState (initialState);
		initialState.action2 ("est", context, 5);
