...
import tfg.sw.implementationExample.pattern.state.ExampleCorrect.State;

import tfg.sw.implementationExample.pattern.state.ExampleCorrect.Context;

import tfg.sw.implementationExample.pattern.state.ExampleCorrect.State1;


public class ExampleCorrectStatePatternAceptedTransitionSecuenceTest {
	...
	private State executeActionSecuence (List<Integer> transitonOrder) throws Exception {
		...
		if (initialStateClassName.compareTo("tfg.sw.implementationExample.pattern.state.ExampleCorrect.State1") != 0) 
			return null;
	...
	private List<String> getFinalStatesCanonicalNames () {
		...
		result.add("tfg.sw.implementationExample.pattern.state.ExampleCorrect.State1");
		result.add("tfg.sw.implementationExample.pattern.state.ExampleCorrect.State3");
