...
public class ExampleNotOrderDependentWrongStatePatternAceptedTransitionSecuenceTest {
	...
	private List<String> getFinalStatesCanonicalNames () {
		...
		result.add("tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentWrong.State1");
		result.add("tfg.sw.implementationExample.pattern.state.ExampleNotOrderDependentWrong.State3");
